      ...
      <header className="fixed top-0 left-0 right-0 z-50 bg-surface/80 backdrop-blur-md">
        <div className="flex justify-between items-center w-full px-6 py-4 max-w-5xl mx-auto">
          <div className="flex items-center gap-2">
            <span className="font-headline font-black text-primary tracking-tight text-3xl">
              Verba
            </span>
          </div>
          <Link
            to="/explore"
            className="font-headline text-primary font-semibold hover:bg-primary/10 rounded-lg transition-colors px-4 py-2"
          >
            Skip
          </Link>
        </div>
        ...
        <div className="max-w-5xl mx-auto px-6 w-full grid grid-cols-1 md:grid-cols-12 gap-12 items-center">
          ...
          <div className="md:col-span-7 flex flex-col items-start gap-8">
            <div className="space-y-4">
              ...
              <p className="font-body text-xl md:text-2xl text-on-surface-variant max-w-lg leading-relaxed">
                Your AI Speaking Companion designed to bridge the gap between
                learning and living.
              </p>
            </div>
            ...
            <div className="flex flex-col sm:flex-row gap-4 w-full sm:w-auto z-10">
              <Link
                to="/signin"
                className="px-8 py-4 bg-primary text-on-primary rounded-full font-headline font-semibold text-base shadow-xl shadow-primary/20 hover:-translate-y-1 hover:shadow-2xl hover:shadow-primary/30 active:scale-95 transition-all duration-300 ease-out flex items-center justify-center gap-2"
              >
                Get Started
              ...
              <div className="flex -space-x-4">
                <div className="w-12 h-12 rounded-full border-4 border-surface overflow-hidden">
                  <img
                    ...
                    alt="User 1"
                    src="https://lh3.googleusercontent.com/aida-public/AB6AXuBl9BG8gZtjHo7bQ9yFyEPt-x13Lp8qBYstZzcn91f6UsT4IC83CaiNX4lmtliUOLL70di9W__NEbIlqcnkSsl0IKh9pM1SEPlhVGgewQ_NJp3htA6zW3pF2nIWjkJxPemN5iRilHwItGY6XR2vcmaejMqfvdOFA8dYUP90HChIViqst48x5xE9Ul4wIeu9iS01YgFpntVeTYkdBrZRc17ezw8B6D7hNengHP9P7dUNHZ2of0Z120C8ddeE78tldva-XCUOKW2FI8g"
                  />
                </div>
                <div className="w-12 h-12 rounded-full border-4 border-surface overflow-hidden">
                  <img
          ...
          <div className="md:col-span-5 relative flex justify-center items-center py-12">
            ...
            >
              <div
                className={cn(
                  "w-20 h-20 bg-surface/20 backdrop-blur-md rounded-full flex items-center justify-center",
              ...
              >
                <p className="text-[12px] font-bold text-primary uppercase tracking-widest mb-1">
                  Feedback
                </p>
                <p className="text-sm font-medium text-on-surface leading-snug">
                  "Excellent pronunciation of 'Resonance'!"
                </p>
              </motion.div>
            ...
            <div
              className={cn(
                "absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[120%] h-[120%] border-2 border-outline-variant/10 rounded-full pointer-events-none",
                !prefersReducedMotion && "animate-[spin_20s_linear_infinite]",
              )}
            ></div>
      ...
      <footer className="w-full py-8 px-6 mt-auto">
        <div className="max-w-5xl mx-auto flex flex-col md:flex-row justify-between items-center gap-4 opacity-60">
          <p className="text-sm font-label">
            © 2024 Verba. All rights reserved.
          </p>
